Rectangle Mania: Given an array of coordinates, determine how many rectangles exist in the coordinates. Return an Integer
...
def getRectangleCount(coords,coordsTable):
	...
	for x1,y1 in coords:
		for x2,y2 in coords:
			...
			rightCordString = coordToString([x2,y1])
			if upperCoordString in coordsTable and rightCordString in coordsTable:
				rectangleCount +=1
