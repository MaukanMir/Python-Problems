...
Success
Details 
Runtime: 544 ms, faster than 91.53% of Python3 online submissions for Number of Unique Flavors After Sharing K Candies.
Memory Usage: 31.4 MB, less than 27.42% of Python3 online submissions for Number of Unique Flavors After Sharing K Candies.
...
class Solution:
    def shareCandies(self, candies: List[int], k: int) -> int:
        ...
        for i in range(0,len(candies)-k):
            ...
            if seen[candies[i+k]] ==0:
                del seen[candies[i+k]]
