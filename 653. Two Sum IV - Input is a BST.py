...
class Solution:
 ...
 Success
Details 
Runtime: 130 ms, faster than 43.88% of Python3 online submissions for Two Sum IV - Input is a BST.
Memory Usage: 16.4 MB, less than 75.24% of Python3 online submissions for Two Sum IV - Input is a BST.
